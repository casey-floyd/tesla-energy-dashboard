    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-5">
        ...
        <Card className="border border-slate-100 shadow-sm rounded-2xl">
          ...
          <CardContent className="px-4 pb-4">
            <ProductionChart entries={history?.time_series ?? []} loading={historyLoading || siteLoading} />
          </CardContent>
        </Card>
          ...
          <Card className="lg:col-span-2 border border-slate-100 shadow-sm rounded-2xl">
            <CardHeader className="pb-2 pt-4 px-5">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-semibold text-slate-700">Energy History</CardTitle>
            ...
            <CardContent className="px-4 pb-4">
              <EnergyHistoryChart entries={history?.time_series ?? []} period={period} loading={historyLoading} />
            </CardContent>
          </Card>
