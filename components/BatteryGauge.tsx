...
export function BatteryGauge({ data, siteInfo, loading }: Props) {
  if (loading || !data) {
    return <div className="w-full h-full min-h-40 bg-slate-50 animate-pulse rounded-2xl" />
  }
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-2 py-2">
      ...
      <div className="text-center">
        ...
        {timeRemaining && <p className="text-xs text-slate-400 mt-0.5">{timeRemaining}</p>}
        {siteInfo && (
